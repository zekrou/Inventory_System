          ...
          <form role="form" action="<?php base_url('company/update') ?>" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Enter company name" value="<?php echo isset($company_data['company_name']) ? $company_data['company_name'] : '' ?>" autocomplete=" off">
              </div>
              <div class="form-group">
