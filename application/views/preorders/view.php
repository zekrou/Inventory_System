            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="label label-<?php
                                                                echo $preorder['status'] == 'pending' ? 'warning' : ($preorder['status'] == 'approved' ? 'success' : ($preorder['status'] == 'completed' ? 'info' : 'danger'));
                                                                ?>">
                                        <?php
                                        $status_labels = [
                                            'pending' => 'En attente',
                        ...
                        <?php if (isset($user_permission['updatePreOrder'])): ?>
            ...
            <div class="col-md-4">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <?php if (isset($user_permission['deletePreOrder'])): ?>
