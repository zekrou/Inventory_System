                                                ...
                                                <select class="form-control select2-product" name="product[]" data-row-id="<?php echo $x; ?>" id="product<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" style="width:100%" required>
                                                    ...
                                                    <?php foreach($products as $p): ?>
                                                        <option value="<?php echo $p['id']; ?>" 
                                                                ...
                                                                data-price-superwholesale="<?php echo isset($p['price_superwholesale']) ? $p['price_superwholesale'] : $p['price_default']; ?>"
...
function addRow() {
    ...
    html += '<td><input type="text" name="rate" id="rate'+rowNum+'" class="form-control" readonly><input type="hidden" name="rate_value[]" id="ratevalue'+rowNum+'"></td>';
    html += '<td><input type="text" name="amount" id="amount'+rowNum+'" class="form-control" readonly><input type="hidden" name="amount_value[]" id="amountvalue'+rowNum+'"></td>';
...
function getTotal(rowid) {
    ...
    var rate = parseFloat($('#ratevalue'+rowid).val()) || 0;
    var amount = qty * rate;
    
    $('#amount'+rowid).val(amount.toFixed(2) + ' DZD');
    $('#amountvalue'+rowid).val(amount.toFixed(2));
