  ...
  <section class="sidebar">
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if($user_permission): ?>
        ...
        <!-- ========== CUSTOMERS ⭐ NOUVEAU ========== -->
        <?php if(in_array('viewCustomer', $user_permission) || in_array('createCustomer', $user_permission)): ?>
        <li id="customerNav">
        ...
        <!-- ========== SUPPLIERS ⭐ NOUVEAU ========== -->
        <?php if(in_array('viewSupplier', $user_permission) || in_array('createSupplier', $user_permission)): ?>
        <li id="supplierNav">
        ...
        <!-- ========== STOCK ⭐ NOUVEAU ========== -->
        <?php if(in_array('viewStock', $user_permission) || in_array('viewStockHistory', $user_permission)): ?>
        <li class="treeview" id="mainStockNav">
          ...
          <ul class="treeview-menu">
            ...
            <?php endif; ?>
            <?php if(in_array('viewStockHistory', $user_permission)): ?>
        ...
        <!-- ========== PURCHASES ⭐ NOUVEAU ========== -->
        <?php if(in_array('viewPurchase', $user_permission) || in_array('createPurchase', $user_permission)): ?>
        <li class="treeview" id="mainPurchaseNav">
          ...
          <ul class="treeview-menu">
            ...
            <?php endif; ?>
            <?php if(in_array('viewPurchase', $user_permission)): ?>
