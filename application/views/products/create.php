                ...
                <div class="box box-info">
                  ...
                  <div class="box-body">
                    ...
                    <div class="alert alert-info">
                      ...
                      Example: Cost 10,000 → Super Gros 11,000 (+10%) → Gros 11,500 (+15%) → Détail 13,000 (+30%)
                    </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-lg">
                            ...
                            <input type="number" step="0.01" class="form-control" id="price_default" name="price_default" placeholder="Enter your cost/purchase price" autocomplete="off" required />
                          </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="price_super_wholesale">
                            <i class="fa fa-truck"></i> Super Gros Price (Super Wholesale)
                            <span class="text-danger">*</span>
                          </label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="price_wholesale">
                            <i class="fa fa-building"></i> Gros Price (Wholesale)
                            <span class="text-danger">*</span>
                          </label>
                          <div class="input-group">
                            <span class="input-group-addon">DZD</span>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="price_retail">
                            <i class="fa fa-shopping-cart"></i> Détail Price (Retail)
                            <span class="text-danger">*</span>
                          </label>
                          <div class="input-group">
                            <span class="input-group-addon">DZD</span>
